...
| Column A — address              | Column B — status | Column C — label (optional)    |
|---------------------------------|-------------------|--------------------------------|
| 1234 Nesthorn Drive             | open              | Structure fire                 |
| 56 Mil Potrero Highway          | closed            | Medical assist                 |

* **Column A** — full street address, e.g. `1234 Nesthorn Drive`.
* **Column B** — `open` or `closed` (case-insensitive). Any value other than
  `closed` is treated as open.
* **Column C** — optional free-text description shown in the marker popup.
